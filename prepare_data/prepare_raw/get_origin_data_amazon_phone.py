...
class Get_amazon_data_phone(Get_origin_data_base):

    def __init__(self,init_origin_data,data_name):
        super(Get_amazon_data_phone, self).__init__(data_name=data_name)
        root = '/home/zxl/project/MTAM-t2/'
        self.raw_data_path = root+"data/raw_data/amazon_"+data_name+"/Cell_Phones_and_Accessories.json"
        self.raw_data_path_meta = root+"data/raw_data/amazon_"+data_name+"/meta_Cell_Phones_and_Accessories.json"
