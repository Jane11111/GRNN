...
class Get_fs_data(Get_origin_data_base):
    ...
    def __init__(self, init_origin_data,data_name):
        ...
        super(Get_fs_data, self).__init__(data_name=data_name)
        root = '/home/zxl/project/MTAM-t2/'

        self.raw_data_path1 = root+"data/raw_data/"+data_name+"/dataset_TSMC2014_NYC.csv"
        self.raw_data_path2 = root+"data/raw_data/"+data_name+"/dataset_TSMC2014_TKY.csv"
